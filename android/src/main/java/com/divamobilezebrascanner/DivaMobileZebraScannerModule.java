...
@ReactModule(name = ReactNativeZebraScannerModule.NAME)
public class ReactNativeZebraScannerModule extends ReactContextBaseJavaModule implements EMDKListener, DataListener, StatusListener, ScannerConnectionListener {
  ...
  public static final String NAME = "ReactNativeZebraScanner";

  public ReactNativeZebraScannerModule(ReactApplicationContext reactContext) {
        super(reactContext);
